...
function gregsHighPerformanceSEO($plugin_prefix='') {
$this->__construct($plugin_prefix);
return;
} 
...
function opt($name) { // get our options
return get_option($this->plugin_prefix . $name);
} // end option retriever

function opt_clean($name) { // get cleaned up options
...
$supported = array('keyword','keywords','autometa','_headspace_keywords','_headspace_metakey');
